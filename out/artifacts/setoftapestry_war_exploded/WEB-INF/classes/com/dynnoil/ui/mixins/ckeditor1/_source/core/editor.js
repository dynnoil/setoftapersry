...
(function()
{
	...
	var onConfigLoaded = function( editor )
	{
		 ...
		 * @type String
		 * @example
		 * alert( editor.skinPath );  // "http://example.com/com.dynnoil.ui.mixins.ckeditor/skins/kama/" (e.g.)
		 */
		...
		CKEDITOR.plugins.load( plugins.split( ',' ), function( plugins )
			{
				 ...
				 * @type Object
				 * @example
				 * alert( editor.plugins.dialog.path );  // "http://example.com/com.dynnoil.ui.mixins.ckeditor/plugins/dialog/" (e.g.)
				 */
		...
		CKEDITOR.themes.load( theme, function()
			{
				 ...
				 * @type CKEDITOR.theme
				 * @example
				 * alert( editor.theme );  "http://example.com/com.dynnoil.ui.mixins.ckeditor/themes/default/" (e.g.)
				 */
