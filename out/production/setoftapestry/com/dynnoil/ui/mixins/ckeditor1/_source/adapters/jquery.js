 ...
 * ".com.dynnoil.ui.mixins.ckeditor" namespace and can be binded/listened on supported textarea, div and p nodes.
 *
 * Available jQuery events:
 * - instanceReady.com.dynnoil.ui.mixins.ckeditor( editor, rootNode )
 *   Triggered when new instance is ready.
 * - destroy.com.dynnoil.ui.mixins.ckeditor( editor )
 *   Triggered when instance is destroyed.
 * - getData.com.dynnoil.ui.mixins.ckeditor( editor, eventData )
 *   Triggered when getData event is fired inside editor. It can change returned data using eventData reference.
 * - setData.com.dynnoil.ui.mixins.ckeditor( editor )
 *   Triggered when getData event is fired inside editor.
 *
 * @example
 * <script src="jquery.js"></script>
 * <script src="com.dynnoil.ui.mixins.ckeditor.js"></script>
...
(function()
{
	 ...
	 * @type Boolean
	 * @example
	 * $( 'textarea' ).com.dynnoil.ui.mixins.ckeditor();
	 * // ...
	...
	/** @lends jQuery.fn */
	{
		...
		ckeditorGet: function()
		{
			...
			if ( !instance )
				throw "CKEditor not yet initialized, use com.dynnoil.ui.mixins.ckeditor() with callback.";
			return instance;
		},
		/**
		 ...
		 * Callback is fiered in "this" scope being com.dynnoil.ui.mixins.ckeditor instance and having source textarea as first param.
		 *
		 * @param config Configuration options for new instance(s) if not already created.
		 * See URL
		 *
		 * @example
		 * $( 'textarea' ).com.dynnoil.ui.mixins.ckeditor( function( textarea ) {
